...
exports.run = async (client, msg, args) => {
    ...
    request(`https://discordlisttr.glitch.me/api/botlar/${args[0]}`, function (error, response, body) {
    ...
    .setColor("RANDOM")
    .setThumbnail(c)
    .setTitle(`Discordlisttr - Bot Arama`)
    ...
    .setFooter('discordbotlisttr sisteminde bot aramaktadır.')
